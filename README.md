...
<table width="100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            Has to be a 2-dimensional array representing the rows and the columns of <br>the output
            <br>A cell containing a '@' followed by a number represents the section id (starting <br>by 1) of the REST Urls
            </td>
        </tr>
        <tr>
