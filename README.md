...
<table width="100%">
    ...
    <tbody>
        <tr>
			...
			- You may also add a `transform` function to convert the value before displaying it.  Use a string that is a 
				<br>common mathematical function with the value of the raw REST data is `value`.  E.g., `value/1000` 
